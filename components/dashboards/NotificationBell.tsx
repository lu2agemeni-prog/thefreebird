  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="relative p-4 md:p-2 bg-white text-gray-700 border rounded-full md:rounded-lg shadow-xl md:shadow-sm hover:bg-gray-50 flex items-center justify-center transition-colors"
      >
        <Bell className="w-6 h-6" />
        {unreadCount > 0 && (
          <span className="absolute top-0 right-0 md:-top-1 md:-right-1 bg-red-500 text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full animate-bounce">
            {unreadCount}
          </span>
        )}
      </button>
      ...
      {isOpen && (
        <div className="absolute left-0 bottom-full mb-2 md:bottom-auto md:top-full md:mt-2 md:mb-0 w-80 sm:w-96 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden" dir="rtl">
